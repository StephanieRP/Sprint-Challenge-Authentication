...
1. What is the purpose of using _sessions_?
   _Its to help users stay logged in when they navigate through the site performing different request. You can keep a user logged in for as long as you see fit._
1. What does bcrypt do to help us store passwords in a secure manner.
   _It can hash your password multiple times which makes it impossible for hackers to get your password._
1. What does bcrypt do to slow down attackers?
   _It makes it harder for hackers to decrypt so that they cannot hack into your applications_
1. What are the three parts of the JSON Web Token?
   _There is the header, payload, and signature._
